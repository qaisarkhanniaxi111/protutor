...
Route::any('/group2', [GroupLessonController::class, 'groupclasses'])->name('public.lessons.2');
Route::any('/group', [GroupLessonController::class, 'groupclasses2'])->name('public.lessons');
