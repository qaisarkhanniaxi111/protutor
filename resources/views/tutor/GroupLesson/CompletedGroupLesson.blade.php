        ...
        <div>
            <ul class="nav tab-nav">
                ...
                <li class="nav-item">
                    ...
                    <button data-bs-toggle="tab" data-bs-target="#tab-2" class="active">
                    @else
                ...
                <li class="nav-item">
                    @if ($errors->any())
                        <button id="createQuiz" data-bs-toggle="tab" data-bs-target="#tab-3" class="active">
                        @else
            ...
            <div class="tab-content pt-3">
                @if ($errors->any() || !empty(session()->get('groupLessonCreated')))
                            ...
                            <tr>
                                <th>
                                    ...
                                    <span class="table-inp"><input type="text"
                                            placeholder="Enter Quiz Title to Search" id="search_drafts_quiz_title"
                                            onkeyup="filterDrafts()"></span>
                                </th>
                                <th>
                                    <span class="table-title">Class / Grade <i class="fa-solid fa-sort"></i></span>
                        ...
                        <thead>
                            <tr>
                                <th>
                                    <span class="table-title">Quiz Title <i class="fa-solid fa-sort"></i></span>
                                    <span class="table-inp"><input type="text"
                                            placeholder="Enter Quiz Title to Search" id="upcoming_quiz_title_filter"
                                ...
                                <th>
                                    <span class="table-title">Start Date <i class="fa-solid fa-sort"></i></span>
                                    <span class="table-inp"><input type="date" placeholder="Enter Name to Search"
                                            id="upcoming_start_date_filter" onchange="upcomingFilter()"></span>
                                </th>
                                <th>
                                    <span class="table-title">End Date <i class="fa-solid fa-sort"></i></span>
                                    <span class="table-inp"><input type="date" id="upcoming_end_date_filter"
                                            onchange="upcomingFilter()" placeholder="Enter Name to Search"></span>
                                </th>
                                <th>
                                    <span class="table-title">Actions</span>
                                </th>
