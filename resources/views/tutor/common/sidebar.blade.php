...
<section class="side-bar">
  <ul>
    ...
    <li><a class="<?php echo ($getVal =='profile') ? 'active' : '' ?>" href="javascript:void(0)"><span><i class="fa-solid fa-user"></i></span> <span>Profile</span></a></li>
    ...
    <li><a href="javascript:void(0)"><span><i class="fa-solid fa-chalkboard-user"></i></span> <span>Teaching Orders</span></a></li>
  ...
  <ul>
    ...
    <li><a href="javascript:void(0)"><span><i class="fa-solid fa-gear"></i></span> <span>Settings</span></a></li>
