              ...
              ?>
                ...
                <div class="col-sm-12 col-lg-12">
                    <div class="inp-outer">
                        ...
                        <input class="input" type="text" value="{{ $Homepagedata[0]->sec2_main_heading }}"
                            name="sec2_main_heading">
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="inp-outer">
                        ...
                        <input type="hidden" name="hidden_sec2_part1_file"
                            value="{{ $Homepagedata[0]->sec2_part1_file }}">
                        <img src="{{ url('/') }}/images/{{ $Homepagedata[0]->sec2_part1_file }}"
                            alt="" width="100" height="100">
                        <?php } ?>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="inp-outer">
                        <label for="">Heading</label>
                        <input class="input" type="text" value="{{ $Homepagedata[0]->sec2_part1_heading }}"
                            name="sec2_part1_heading">
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="inp-outer">
                        ...
                        <input class="input" type="text" value="{{ $Homepagedata[0]->sec2_part1_url }}"
                            name="sec2_part1_url">
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="inp-outer">
                        ...
                        <input type="hidden" name="hidden_sec2_part2_file"
                            value="{{ $Homepagedata[0]->sec2_part2_file }}">
                        <img src="{{ url('/') }}/images/{{ $Homepagedata[0]->sec2_part2_file }}"
                            alt="" width="100" height="100">
                        <?php } ?>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="inp-outer">
                        <label for="">Heading</label>
                        <input class="input" type="text" value="{{ $Homepagedata[0]->sec2_part2_heading }}"
                            name="sec2_part2_heading">
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="inp-outer">
                        <label for="">Learn More URL</label>
                        <input class="input" type="text" value="{{ $Homepagedata[0]->sec2_part2_url }}"
                            name="sec2_part2_url">
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="inp-outer">
                        <label for="">Image</label>
                        <input class="input" type="file" name="sec2_part3_file">
                        <?php if(isset($Homepagedata[0]->sec2_part3_file)){ ?>
                        <input type="hidden" name="hidden_sec2_part3_file"
                            value="{{ $Homepagedata[0]->sec2_part3_file }}">
                        <img src="{{ url('/') }}/images/{{ $Homepagedata[0]->sec2_part3_file }}"
                            alt="" width="100" height="100">
                        <?php } ?>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="inp-outer">
                        <label for="">Heading</label>
                        <input class="input" type="text" value="{{ $Homepagedata[0]->sec2_part3_heading }}"
                            name="sec2_part3_heading">
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="inp-outer">
                        <label for="">Learn More URL</label>
                        <input class="input" type="text" value="{{ $Homepagedata[0]->sec2_part3_url }}"
                            name="sec2_part3_url">
                    </div>
                </div>
                ...
                <div class="col-sm-12 col-lg-12">
                    <div class="inp-outer">
                        <label for="">Description</label>
                        <textarea name="sec2_part3_desc" rows="4" class="input">{{ $Homepagedata[0]->sec2_part3_desc }}</textarea>
                    </div>
                </div>
...
{{--
                ...
                <div class="col-sm-12 col-lg-12">
                    <div class="inp-outer">
                        ...
                        <input class="input" type="text" value="{{ $Homepagedata[0]->sec4_main_heading }}"
                            name="sec4_main_heading">
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="inp-outer">
                        <label for="">Heading</label>
                        <input class="input" type="text" value="{{ $Homepagedata[0]->sec4_part1_heading }}"
                            name="sec4_part1_heading">
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="inp-outer">
                        <label for="">Learn More URL</label>
                        <input class="input" type="text" value="{{ $Homepagedata[0]->sec4_part1_url }}"
                            name="sec4_part1_url">
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="inp-outer">
                        <label for="">Heading</label>
                        <input class="input" type="text" value="{{ $Homepagedata[0]->sec4_part2_heading }}"
                            name="sec4_part2_heading">
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="inp-outer">
                        <label for="">Learn More URL</label>
                        <input class="input" type="text" value="{{ $Homepagedata[0]->sec4_part2_url }}"
                            name="sec4_part2_url">
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="inp-outer">
                        ...
                        <input class="input" type="text" value="{{ $Homepagedata[0]->sec7_youtube_url }}"
                            name="sec7_youtube_url">
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="inp-outer">
                        <label for="">Heading</label>
                        <input class="input" type="text" value="{{ $Homepagedata[0]->sec7_heading }}"
                            name="sec7_heading">
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="inp-outer">
                        ...
                        <input class="input" type="text" value="{{ $Homepagedata[0]->sec7_sub_heading1 }}"
                            name="sec7_sub_heading1">
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="inp-outer">
                        ...
                        <input class="input" type="text" value="{{ $Homepagedata[0]->sec7_sub_heading2 }}"
                            name="sec7_sub_heading2">
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="inp-outer">
                        ...
                        <input class="input" type="text" value="{{ $Homepagedata[0]->sec7_sub_heading3 }}"
                            name="sec7_sub_heading3">
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="inp-outer">
                        ...
                        <img src="{{ url('/') }}/images/{{ $Homepagedata[0]->sec9_file }}"
                            alt="" width="100" height="100">
                        <?php } ?>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="inp-outer">
                        <label for="">Heading</label>
                        <input class="input" type="text" value="{{ $Homepagedata[0]->sec9_heading }}"
                            name="sec9_heading">
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="inp-outer">
                        ...
                        <input class="input" type="text" value="{{ $Homepagedata[0]->sec9_play_store_url }}"
                            name="sec9_play_store_url">
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="inp-outer">
                        ...
                        <input class="input" type="text" value="{{ $Homepagedata[0]->sec9_apple_store_url }}"
                            name="sec9_apple_store_url">
                    </div>
                </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var fieldHTML =
            '<div class="field_wrapper"><div class="inp-outer"><label for="">Sub Heading</label><input class="input" type="text" name="sec_1_subheading[]"></div><div class="add-btn remove_button"><i class="fa-solid fa-minus-circle"></i>Remove</div></div>';
