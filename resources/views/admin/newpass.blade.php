        ...
        <div class="row justify-content-center">
            <div class="col-lg-7">
                <div class="login-right-main">
                    ...
                    <p class="pt-3 text-center">Kindly enter your new Password and confirm</p>
                ...
                <form action="{{url('/new-password2')}}" method="post">
                    @csrf()
                    <div class="inp-wrap">
                        <input class="inp" name="password" type="password" placeholder="New Password">
                        <span style="color: red;">@if($errors->has('password'))
                          {{ $errors->first('password');}} 
                      @endif</span>
                  </div>
                  <div class="inp-wrap">
                    <input class="inp" name="password_confirmation"  type="password" placeholder="Confirm Password">
                    <span style="color: red;">@if($errors->has('password_confirmation'))
                      {{ $errors->first('password_confirmation');}} 
                  @endif</span>
                      </div>
                      <div class="inp-wrap">
                        <button type="submit" class="site-link full">Reset Password</button>
                    </div>
                </form>
