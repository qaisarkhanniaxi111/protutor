                ...
                <div class="tutor-list-single alt">
                    <div class="tutor-list-left">
                        <div class="tutor-list-img">
                            <a href="#"><img src="{{ url('/') }}/images/{{ $teacher_data[0]->profile_img }}"
                                    alt=""></a>
                        </div>
                        <div class="tutor-list-txt">
                            <div class="tutor-list-info">
                                <h5><a href="#">{{ $teacher_data[0]->first_name . ' ' . $teacher_data[0]->last_name }}&nbsp;
                                    </a></h5>
                                <?php 
                     ...
                     ?>
                            ...
                            <div class="tutor-spec"><span><i
                                        class="fa-solid fa-comments"></i></span><span><strong>Speaks:</strong></span><span>
                                    <?php
                ...
                <div class="tutor-says">
                    ...
                    <div class="student-review">
                        <div class="student-review-single">
                            <div class="student-review-img"><img
            ...
            <div class="box">
                <div class="tutor-list-single alt">
                    ...
                    if(isset($teacher_data[0]->video_link) and $teacher_data[0]->video_link!=''){
                        ?>
                            <iframe class="embed-responsive-item"
                                src="{{ url('/') }}/videos/{{ $teacher_data[0]->video_link }}"
                    ...
                    ?>
                        ...
                        <div class="lesson-time"><i class="fa-solid fa-chart-line"></i> 4 Lessons booked in the last
                            48 hours</div>
                        <div class="pop-badge">
