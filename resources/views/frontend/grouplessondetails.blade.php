    ...
    <div class="container" id="lesson_details_container">
        <div class="row">
            <div class="col-12">
                        ...
                        <table class="table" id="lesson_details_table" style="margin-top: 5%;">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td>{{ config('protutor.currency') }}{{ $groupLesson ? $groupLesson->price : '' }} / Class</td>
                                </tr>
                ...
                @if ($paymentStatus == 'paid')
                    <div class="text-center">
                        <a href="{{ url('chat/'.$tutor->id) }}" class="btn" style="background: #FF6C0B; color:white">Chat with {{ $groupLesson->tutor ? $groupLesson->tutor->fullname: '' }}</a>
                    </div>
                @elseif($paymentStatus == 'unpaid')
                    ...
                    <div class="row">
                        <div class="splitscreen">
                            ...
                            <div class="right">
                                <form method="post" action="{{ route('payments.charge',$groupLesson ? $groupLesson->id: '') }}">
                                    @csrf
                ...
                <div class="card mb-5">
                    <div class="card-body">
                        ...
                        <form action="{{ route('submit.review') }}" method="post">
                            @csrf
                            <input type="number" name="group_lesson_id" value="{{ $groupLesson->id }}" hidden>
                            <input type="number" name="student_id" value="{{ auth()->user() ? auth()->user()->id: '' }}" hidden>
