          ...
          <div class="slider-card ">
            ...
            <div class="profile">
              <div class="person-data">
                <div class="person">
                  <img class="-person-image" alt="Image" src="{{ asset('assets/frontpage_assets/images/Ellipse_2670.svg') }}" />
              ...
              <div class="price-panal">
                ...
                <div class="top-reviews">
                  <div class="reviews-box">
                    <img class="review-2" alt="Image" src="./images/startingCardmages/Ellipse 2669.svg" />
                    <img class="review-3" alt="Image" src="./images/startingCardmages/Ellipse 2671.svg" />
                    <img class="review-4" alt="Image" src="./images/startingCardmages/Ellipse 2672.svg" />
                    <img class="review-5" alt="Image" src="./images/startingCardmages/Ellipse 2673.svg" />
        ...
        <div class="card-wrapper">
          <div class="slider-card">
            ...
            <div class="profile">
              <div class="person-data">
                <div class="person">
                  <img class="-person-image" alt="Image" src="./images/startingCardmages/Ellipse 2670.svg" />
                  <div class="text-wrapper-4">Jordyn Ekst</div>
                </div>
                <div class="vl"></div>
                <div class="reviews">
